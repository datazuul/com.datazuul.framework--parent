...
import com.googlecode.flyway.core.FlywayBeanAware;
...
public class ClassUtils {
    ...
    public static synchronized <T> T instantiate(String className) throws Exception {
        // diff to original is using (configurable) beans from application context
        // start
        ApplicationContext applicationContext = FlywayBeanAware.getApplicationContext();
        if (applicationContext != null) {
            Object instance = null;
            try {
                instance = applicationContext.getBean(Class.forName(className, false, getClassLoader()));
