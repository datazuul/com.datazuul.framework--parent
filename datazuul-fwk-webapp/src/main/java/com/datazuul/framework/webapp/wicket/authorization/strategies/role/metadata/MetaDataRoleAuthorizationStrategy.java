package com.datazuul.framework.webapp.wicket.authorization.strategies.role.metadata;
...
import com.datazuul.framework.webapp.wicket.authorization.strategies.role.AbstractRoleAuthorizationStrategy;
...
public class MetaDataRoleAuthorizationStrategy extends AbstractRoleAuthorizationStrategy {
     ...
     */
    public static final void authorize(final Component component, final Action action, final String roles) {
     ...
     */
    public static final <T extends Component> void unauthorize(final Class<T> componentClass, final String roles) {
     ...
     *            action
     */
    public static final void unauthorize(final Component component, final Action action, final String roles) {
     ...
     */
    private static <T extends IRequestableComponent> Roles rolesAuthorizedToInstantiate(final Class<T> componentClass) {
	final InstantiationPermissions permissions = Application.get().getMetaData(INSTANTIATION_PERMISSIONS);
	if (permissions != null) {
     ...
     */
    private static Roles rolesAuthorizedToPerformAction(final Component component, final Action action) {
	final ActionPermissions permissions = component.getMetaData(ACTION_PERMISSIONS);
	if (permissions != null) {
